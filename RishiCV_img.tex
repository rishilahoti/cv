...
\begin{flushleft}
    \begin{minipage}[b]{0.7\linewidth} % Adjust the width as needed
    ...
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.2\linewidth} % Adjust the width as needed
        \includegraphics[width=\linewidth]{file:///C:/Users/rishi/Downloads/android-chrome-512x512.png} % Insert your photo here
    \end{minipage}
\end{flushleft}
